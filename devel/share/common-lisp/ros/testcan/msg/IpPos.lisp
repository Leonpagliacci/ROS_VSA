...
(cl:defmethod cl:initialize-instance :after ((m <IpPos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IpPos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testcan-msg:<IpPos> is deprecated: use testcan-msg:IpPos instead.")))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <IpPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testcan-msg:pos-val is deprecated.  Use testcan-msg:pos instead.")
  (pos m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <IpPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testcan-msg:angle-val is deprecated.  Use testcan-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <IpPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testcan-msg:id-val is deprecated.  Use testcan-msg:id instead.")
  (id m))
