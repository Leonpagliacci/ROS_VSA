...
int flagrecord[28];
bool enable_leg,enable_arm,enable_wheel,enable_AP_feedback,enable_RP_feedback,enable_I_feedback,enable_V_feedback,enable_wheelspeed_feedback,single_motor_test;
...
void CANopenVCIROS::rosnode(){
    ...
    nh_.param("test_motor_id",test_motor_id,10);
...
int CANopenVCIROS::PDO_init(int dev_id){
    char IP_Mode_init[48][8] = {{0x40, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00},
                                ...
                                {0x2F, 0x01, 0x18, 0x02, 0x00, 0x00, 0x00, 0x00},
                                {0x2B, 0x01, 0x18, 0x03, 0x10, 0x27, 0x00, 0x00},
                                {0x2B, 0x01, 0x18, 0x05, 0x00, 0x00, 0x00, 0x00},
                                {0x2F, 0x01, 0x1A, 0x00, 0x00, 0x00, 0x00, 0x00},//清除TPDO映射对象
                                {0x23, 0x01, 0x1A, 0x01, 0x20, 0x00, 0x69, 0x60},//TPDO2映射对象606C(速度反馈)
        ...
        for (int i = 0;i < 48;i++){
            send(dev_id,CAN1,WriteSDO,IP_Mode_init[i],48);///48个包48次
            usleep(10000);
        // printf("OK once\n");
        }
...
void CANopenVCIROS::GetInitPos(testcan::Frame can_receive){
    ...
    if ((can_receive.id > ReadSDO)&&(flagrecord[dev_id] == 0)){
        ...
        double init_pos_degree = init_pos*0.036/10485.76;//20位编码器，减速比100
...
void CANopenVCIROS::PosCmdCallback(const testcan::IpPos::ConstPtr &cmd){
    ...
    if (dev_id == 1 || dev_id == 7 || dev_id == 8 || dev_id == 14){
        ...
        data_receive = 360 - data_receive_print;
    }
    int data = int(data_receive*10485.76/0.036);
...
int main(int argc, char *argv[])
{
    ...
    char sdoAP[8]= {0x40,0x7A,0x60,0x00,0x00,0x00,0x00,0x00};      //目标位置                                                                                                                                                                                                                                                                                                      
    ...
    */
    ...
    if(enable_arm){
        ...
        CANopenVCIROS1.PDO_init(8);
        CANopenVCIROS1.PDO_init(9);
        CANopenVCIROS1.PDO_init(10);
        CANopenVCIROS1.PDO_init(11);
        CANopenVCIROS1.PDO_init(12);
        CANopenVCIROS1.PDO_init(13);
    ...
    if(enable_arm){
        ...
        CANopenVCIROS1.send(3,CAN1,WriteSDO,sdoRP,1);
        ...
        CANopenVCIROS1.send(7,CAN1,WriteSDO,sdoRP,1);
        CANopenVCIROS1.send(8,CAN1,WriteSDO,sdoRP,1);
        CANopenVCIROS1.send(9,CAN1,WriteSDO,sdoRP,1);
        CANopenVCIROS1.send(10,CAN1,WriteSDO,sdoRP,1);
        CANopenVCIROS1.send(11,CAN1,WriteSDO,sdoRP,1);
        CANopenVCIROS1.send(12,CAN1,WriteSDO,sdoRP,1);
        CANopenVCIROS1.send(13,CAN1,WriteSDO,sdoRP,1);
        CANopenVCIROS1.send(14,CAN1,WriteSDO,sdoRP,1);
    }
...
if(enable_leg){
    ...
    CANopenVCIROS1.send(1,CAN1,WriteSDO,sdoclear,1); 
    CANopenVCIROS1.send(2,CAN1,WriteSDO,sdoclear,1);    
    CANopenVCIROS1.send(3,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(4,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(5,CAN1,WriteSDO,sdoclear,1); 
    CANopenVCIROS1.send(6,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(7,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(8,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(9,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(10,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(11,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(12,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(13,CAN1,WriteSDO,sdoclear,1);
    CANopenVCIROS1.send(14,CAN1,WriteSDO,sdoclear,1);
    
    CANopenVCIROS1.send(1,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(2,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(3,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(4,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(5,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(6,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(7,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(8,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(9,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(10,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(11,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(12,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(13,CAN1,WriteSDO,sdo_enable,1);
    CANopenVCIROS1.send(14,CAN1,WriteSDO,sdo_enable,1);

    // CANopenVCIROS1.send(0x03,CAN1,WriteSDO,sdoclear,1);
    // CANopenVCIROS1.send(0x07,CAN1,WriteSDO,sdoclear,1);
    // CANopenVCIROS1.send(0x03,CAN1,WriteSDO,sdo_enable,1);
    // CANopenVCIROS1.send(0x07,CAN1,WriteSDO,sdo_enable,1);
 	while (ros::ok())
	{
        /*
        ...
        */
        if(enable_wheelspeed_feedback){
            wheel_id = wheel_id + 0x11;
            GetVel[1] = wheel_id;
            CANopenVCIROS1.send(wheel_id,CAN2,DIS,GetVel,1);
            if(wheel_id == 0x44){
                wheel_id = 0x00;
            }
        }
